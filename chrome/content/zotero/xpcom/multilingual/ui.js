...
Zotero.setCitationLanguages = function (obj, citeproc) {
    ...
    obj.citationTransliteration = Zotero.CachedLanguages.getLangPrefsForParam('citationTransliteration', true);
    obj.citationTranslation = Zotero.CachedLanguages.getLangPrefsForParam('citationTranslation', true);
    obj.citationSort = Zotero.CachedLanguages.getLangPrefsForParam('citationSort', true);
	if (citeproc) {
