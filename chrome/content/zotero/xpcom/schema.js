		...
		try {
			...
			try {
				...
				if (Zotero.DB.valueQuery(sql) == 0) { 
					...
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('zh-alalc97','Chinese (rm)','zh')";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('en','English',NULL)";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('ja','Japanese',NULL)";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('ja-alalc97','Japanese (rm)','ja')";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('ja-Kana','Japanese (\u30ab\u30ca)','ja')";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('km','Khmer',NULL)";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('km-alalc97','Khmer (rm)','km')";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('lo','Laotian','')";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('lo-alalc97','Laotian (rm)','lo')";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('mn','Mongolian',NULL)";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('mn-alalc97','Mongolian (rm)','mn')";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('my','Myanmar',NULL)";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('my-alalc97','Myanmar (rm)','my')";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('ru','Russian',NULL)";
					Zotero.DB.query(sql);
					var sql = "INSERT INTO zlsTags VALUES('ru-alalc97','Russian (rm)','ru')";
					Zotero.DB.query(sql);
