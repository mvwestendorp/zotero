diff --git a/tools/make_jurisdiction_filter.py b/tools/make_jurisdiction_filter.py
new file mode 100755
index 0000000..4a5e01a
--- /dev/null
+++ b/tools/make_jurisdiction_filter.py
@@ -0,0 +1,47 @@
+#!/usr/bin/python
+
+import sys,os,json
...
+            else:
+                uistr = obj[key]["name"]
+            strs.append("    \"%s\":\"%s\"," % (key,uistr.replace("'","")))
